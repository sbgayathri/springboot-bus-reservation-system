...
const BrowseBuses = () => {
  ...
  const handleBookBus = async () => {
    if (!selectedBus || !currentUser) {
      setError('Please login to book tickets');
      return;
    }

    if (seatsToBook <= 0 || seatsToBook > selectedBus.availableseats) {
    ...
    try {
      ...
      const response = await userService.bookBus(bookingData);
    ...
    return (
      <Container className="mt-5">
        <Alert variant="warning">
          Please login to browse and book buses.
        </Alert>
      </Container>
    );
  }
                    ...
                    <Col md={6} lg={4} key={bus.id} className="mb-4">
                      <Card className="h-100">
                        <Card.Header className="bg-secondary text-white">
                          <h6 className="mb-0">Bus #{bus.busnum}</h6>
                        </Card.Header>
                        <Card.Body>
                          <div className="mb-3">
                            <h6>Route</h6>
